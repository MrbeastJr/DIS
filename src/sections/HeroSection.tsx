  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-10 md:bottom-10 bottom-24"
      >
        ...
        >
          <div className="w-[3px] h-[6px] bg-white/30 rounded-full" />
        </motion.div>
      </motion.div>
    </section>
  );
