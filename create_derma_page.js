...
const dermaScanSource = fs.readFileSync('src/components/DermaScan.tsx', 'utf8');
...
if (!fs.existsSync('src/app/derma-scan')){
    fs.mkdirSync('src/app/derma-scan');
}

fs.writeFileSync('src/app/derma-scan/page.tsx', newPage, 'utf8');
console.log('src/app/derma-scan/page.tsx created successfully.');
